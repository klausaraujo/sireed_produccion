...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>public/css/farmacia/main.css?v=<?=date("his")?>" />
    ...
    <div class="page-wrapper content">
        ...
        <div class="row heading-bg">
          ...
          <div class="col-lg-7 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
              ...
              <li><a href="<?=base_url()?>farmacia"><span>Farmacia</span></a></li>
              <li class="active"><span>Módulo Logístico</span></li>
            </ol>
          </div>
        ...
        <div class="col-lg-4">
          ...
          <div>
            ...
            <?php if ($idCategoria > 0) {?>
              <div class="chip">
                <div class="chip-head"><?=$totalCategoria?></div>
      ...
      <div class="row">
        <form id="formCategoria" action="<?=base_url()?>farmacia" method="POST">
          ...
          <div class="col-lg-4">
            <h1 class="my-4 content-title">SELECCIONE LA CATEGORIA DE ARTICULOS A FILTRAR</h1>
            <div class="list-group">
              ...
              <?php foreach($listaCategoria as $row): ?>
                <?php if ($row->id == $idCategoria) {?>
                  <a class="list-group-item btn-clasificacion active" data-value="<?=$row->id?>"><?=$row->descripcion?></a>
                <?php
                } else {?>
                  <a class="list-group-item btn-clasificacion" data-value="<?=$row->id?>"><?=$row->descripcion?></a>
                <?php }?>
              ...
              <div class="col-lg-4 col-md-3 mb-4 nopadding">
                <div class="product-card">
                  <div class="product-tumb">
                    <img src="<?=base_url()?>public/farmacia/fotos/<?=$row->imagen?>"  alt="">
                  </div>
