...
$titulo = "Gesti&oacute;n de Tipo de Acci&oacute;n";
$botonCrear = "Registrar Tipo de Acci&oacute;n";
?>
</head>
<body>
        ...
        <div class="row heading-bg">
          ...
          <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="active"><span>Tipo Acci&oacute;n</span></li>
            </ol>
          </div>
        </div>
        <div class="row">
						...
						<?=$botonCrear?>
                          ...
                          <div class="table-responsive">
                            <table id="tbLista" class="table table-bordered table-sm">
                              <thead>
                                <tr>
                                  <th class="text-center">C&oacute;Tipo de Acci&oacute;n</th>
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
      <form id="formEliminar" action="<?=base_url()?>tablas/main/tipo-accion-eliminar" method="POST">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title">Eliminar Tipo de Acci&oacute;n</h5>
          </div>
          <div class="modal-body">
            &iquest;Seguro(a) desea Borrar el Tipo de Acci&oacute;n <strong id="elementoEliminar"></strong>?
          </div>
  ...
  <div class="modal fade" id="registrarModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form id="formRegistrar" name="formRegistrar" action="<?=base_url()?>tablas/main/tipo-accion-gestionar" method="POST">
          <div class="modal-body">
			<input type="hidden" name="Tipo_Accion_Codigo" value="" readonly />
            <div class="row">
              <div class="col-xs-12">
                <div class="form-group">
                  <label class="">Descripci&oacute;n del Tipo de Acci&oacute;n</label> 
				  <input type="text" class="form-control text-uppercase" name="Tipo_Accion_Descripcion" />
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="<?=base_url()?>public/js/tablas/tipo-accion.js?v=<?=date("s")?>"></script>
  <script>
	tipoAccion("<?=base_url()?>");
</script>
</body>
