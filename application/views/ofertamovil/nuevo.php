													...
													<!--<div class="setup-content" id="step-2" style="display: none;">-->
														<div class="row">
															<div class="col-xs-12">
                                											...
                                											<div class="col-xs-12">
                                    											<div class="form-group d-flex flex-middle flex-direction-column">
                                    												<div class="w-100 d-flex flex-middle mt-10">
                                            											<label class="d-flex flex-middle mr-20 w-100-xs"><input type="checkbox" class="ma-0" name="Vac_Influenza" value="1" />Influenza</label>
                                            											<label class="d-flex flex-middle mr-20 w-100-xs"><input type="checkbox" class="ma-0" name="Vac_Sarampion" value="1" />Sarampión</label>
                                            											<label class="d-flex flex-middle mr-20 w-100-xs"><input type="checkbox" class="ma-0" name="Vac_Tetanos" value="1" />Tetanos</label>
                                            											<label class="d-flex flex-middle mr-10 w-100-xs"><input type="checkbox" class="ma-0" name="Vac_Fiebre" value="1" />Fiebre amarilla</label>
                                        											</div>
                                        											<div class="w-100 d-flex flex-middle mt-10">
                                            											<label class="d-flex flex-middle mr-20 w-100-xs"><input type="checkbox" class="ma-0" name="Vac_Hepatitis" value="1" />Hepatítis B</label>
                                            											<label class="d-flex flex-middle mr-10 w-100-xs"><input type="checkbox" class="ma-0" name="Vac_Otros" value="1" /><span class="mr-10">Otros</span> 
                                            											<input type="text" class="form-control" name="Vac_Otros_Detalle"></label>
                                        											</div>
                                        										</div>
                                											</div>
                                										</div>		
																	...
																	<div class="col-xs-12 col-sm-12">
																			...
																			<div class="col-xs-12">
																				<div class="form-group d-flex flex-middle ">
    																				...
    																				<div class="mt-10 mr-10">
                                            											...
                                            											<div class='input-group date datetimepicker'>
                                    														<input type="text" class="form-control"name="Lab_Fecha_Recepcion" />
                                    														<span class="input-group-addon">
																								<span class="glyphicon glyphicon-calendar"></span>
                                    														</span>
                                    													</div>
																		...
																		<div class="row">
																			<div class="form-group mr-10">
                                    											...
                                    											<div class="col-xs-12"><input type="text" class="form-control" name="Lab_Resultados" /></div>
																			</div>
																		</div>-->
																	</div>
																		...
																		<div class="row">																		
																			<div class="col-xs-12 col-sm-4">
																				...
																				<div class="input-group cie-small">
																					...
																					<input type="text" name="cie10_1_texto" class="form-control detalle-size" autocomplete="off" readonly />
																					<span class="input-group-btn">
																			...
																			<div class="col-xs-12 col-sm-4">
																				...
																				<div class="input-group cie-small">
																					...
																					<input type="text" name="cie10_2_texto" class="form-control detalle-size" autocomplete="off" readonly />
																					<span class="input-group-btn">
																			...
																			<div class="col-xs-12 col-sm-4">
																				...
																				<div class="input-group cie-small">
																					...
																					<input type="text" name="cie10_3_texto" class="form-control detalle-size" autocomplete="off" readonly />
																					<span class="input-group-btn">
																...
																<div class="row">
																	<div class="col-xs-12">
																		<table class="table" id="table-tratamiento" style="display: none;">
																			<thead>
																				<tr>
																					<th>Medicamento</th>
																					<th>Unidad</th>
																		...
																		<div class="row">
    																		...
    																		<div class="col-xs-12 col-sm-6">
        																		<div class="form-group">
        																			...
        																			<select class="form-control" name="Destino">
        																				...
        																				<option value="3">RETIRO VOLUNTARIO</option>
        																		...
        																		<div class="form-group" id="Condicion_Alta" style="display: none;">
        																			...
        																			<input type="text" class="form-control" name="Lugar_Referencia" />
        																		</div>
        																	</div>
        																	...
        																	<div class="col-xs-12 col-sm-6">
        																		...
        																		<div class="form-group" id="Responsable_Traslado" style="display: none;">
        																			...
        																			<input type="text" class="form-control" name="Responsable_Traslado" />
        																		</div>
        																	</div>
