...
<?php $titulo = "Consolidado Nacional"; ?>
...
<body>
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="active"><span>Consolidado Nacional</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
												...
												<div class="container-fluid">
													...
													<div class="col-xs-12">
														<div class="table-responsive">
															<table class="table tbLista table-bordered table-hover">
																<thead>
																	<tr>
																	<th>REGION</th>
																	<th>PROVINCIA</th>
																	<th>DISTRITO</th>
																	<th>POBLACION LESIONADOS</th>
																	<th>POBLACION FALLECIDOS</th>
																	<th>POBLACION DESAPARECIDOS</th>
																	<th>P.SALUD LESIONADOS</th>
																	<th>P.SALUD FALLECIDOS</th>
																	<th>P.SALUD DESAPARECIDOS</th>
																	<th>IPRESS AFEC.OPER.</th>
																	<th>IPRESS AFEC.INOPER.</th>
																	<th>IPRESS ESSALUD AFEC.</th>
																	...
																	<th>O.M. TIPO II</th>
																	<th>O.M. TIPO III</th>
																	<th>KIT MEDICAMENTOS</th>
																	<th>MOCHILAS EMERGENCIA</th>
																	<th>&nbsp;</th>
																	</tr>
																</thead>
																<tbody>
	...
	<script src="<?=base_url()?>public/js/eventos/reporteConsolidadoNacional.js"></script>
	<script>
		reporteConsolidadoNacional("<?=base_url()?>");
	</script>
