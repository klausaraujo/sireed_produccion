...
?>
	...
	<h2 class="complementario">FECHA DE ACTUALIZACION: <?=$evento->DIA."/".$evento->MES."/".$evento->ANIO." ".$evento->HORA.":".$evento->MINUTO?> HORAS</h2>
	<h2 class="complementario">COMPLEMENTARIO: <?=$evento->evento?> - <?=$evento->departamento?></h2>
	...
	<div>
		...
		<?php if(count($IPRESSInoperativas)>0){ ?>
			<br />
			<h4 align="center">TABLA N&deg; 06 - CONSOLIDADO DE IPRESS AFECTADAS INOPERATIVAS</h4>
		    <table cellpadding="0" cellspacing="0" align="center" class="tabla_fallecidos" style="margin:auto">
        		<thead>
        			<tr>
            			<th style="width:20pt;">N&deg;</th>
