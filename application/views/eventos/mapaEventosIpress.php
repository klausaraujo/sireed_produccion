...
<head>
	...
	<?php $titulo = "Reporte de Mapa de Ipress Afectadas";?>
...
<body>
								...
								<div class="col-xl-12 col-sm-12 col-md-6">
									<div class="form-group">
										<div class='form-check'>
											<input class="form-check-input" type="checkbox" value="1" id="chk_monitoreo" name="tipoOcurrencia[]" checked>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table table-bordered">
				<tr>
					<td><img src="<?=base_url()?>public/map/icons/ic_ipress_blue.png" width="25" /></td>
					<td>Ipress Afectadas Operativas</td>
				</tr>
				<tr>
					<td><img src="<?=base_url()?>public/map/icons/ic_ipress_red.png" width="25" /></td>
					<td>Ipress Afectadas Inoperativas</td>
				</tr>
            </table>
          </div>
        </div>
		...
		<div id="floating-panel" class="text-center">
			<div class="card">
				<table class="table table-bordered">
					<tr>
						<td><img src="<?=base_url()?>public/map/ipress-o.png" width="25" /></td>
						<td>Ipress Afectadas Operativas</td>
					</tr>
					<tr>
						<td><img src="<?=base_url()?>public/map/ipress-i.png" width="25" /></td>
						<td>Ipress Afectadas Inoperativas</td>
					</tr>
				</table>
			</div>
	...
	<script src="<?=base_url()?>public/js/eventos/initMapReporteEventosIpress.js?v=<?=date(" his")?>"></script>
	<script src="<?=base_url()?>public/js/mapas/mapa-eventos-ipress.js?v=<?=date(" his")?>"></script>
	<script>
