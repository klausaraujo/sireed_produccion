...
<body>
											...
											<div class="sm-data-box pa-10">
												<div class="container-fluid">
                                                    ...
                                                    <div class="table-responsive">
    													...
    													<tbody>
    														<tr><td><?=$danios->distrito." ,".$danios->provincia." ,".$danios->departamento?></td>
    															<td><?=$dateTime[0]?></td>
    															<td><?=$dateTime[1]?></td>
													...
													<ul class="enlaces-otros">
														<li><a href="javascript:;" class="enlaceDanios" rel="danios">Registrar Da&ntilde;os</a><span><i class="fa fa-home"></i></span></li>
   ...
   <?php
    ...
    <div class="col-xs-12 col-sm-6 col-md-4">
    		  ...
    		  <p>
																				<b>Tipo Acci&oacute;n: </b><?=$row->Tipo_Accion_Descripcion?></p>
																			<p>
																				<b>Tipo Entidad: </b><?=$row->Tipo_Accion_Entidad_Nombre?></p>
																			<p>
																				<b>Fecha: </b><?=$row->Evento_Acciones_Fecha?></p>
																			<p>
																				<b>Total Brigadistas: </b><?=$row->brigadistas?></p>
																			<p>
																				<b>Total EMT: </b><?=$row->EMT?></p>
																			<p>
																				<b>Total Personal Salud: </b><?=$row->PersonalSalud?></p>
																			<p>
																				<b>Total Ambulancias: </b><?=$row->ambulancias?></p>
																			<p>
																				<b>Total Medic./Insumos: </b><?=$row->medicamentos?></p>
    		...
    		<?php if($lastID==$row->Evento_Acciones_Numero){ ?>
						...
						<div class="row">
							...
							<div class="col-xs-12">
    							...
    							<div class="col-xs-6 col-sm-4 col-sm-2 input-modal-xl">
        								...
        								<div class="form-group one-line">
        									<label class="">MINSA</label> <input type="text"
        										class="form-control"
							...
							<div class="col-xs-6 col-sm-4 col-sm-2 input-modal-xl">
								...
								<div class="form-group one-line">
									<label class="">MINSA - SAMU</label>
									<input type="text" class="form-control"
										name="Evento_Acciones_Minsa_Samu" value="0"
										placeholder="#" autocomplete="off" />
								</div>
								<div class="form-group one-line">
									<label class="">MINSA</label>
									<input type="text" class="form-control"
								...
								<div class="form-group one-line">
									<label class="">Voluntarios</label>
									<input type="text" class="form-control"
										name="Evento_Acciones_Voluntarios" value="0"
										placeholder="#" autocomplete="off" />
								</div>								
								<div class="form-group one-line">
									<label class="">PNP / FF.AA.</label>
									<input type="text" class="form-control"
							...
							<div class="col-xs-12 col-sm-6 col-md-4">
								<div class="form-group">
									<label class="">Tipo acci&oacute;n</label>
							...
							<div class="col-xs-12 col-sm-6 col-md-4">
								<div class="form-group">
									<label class="">Tipo Entidad</label> <select
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label class="">Detalle de acciones</label>
						...
						<div class="row">
							...
							<div class="col-xs-12">
    							...
    							<div class="col-xs-6 col-sm-2 input-modal-xl">
        								...
        								<div class="form-group one-line">
        									<label class="">M&eacute;dicos T&aacute;cticos</label> <input type="text"
        										class="form-control"
