...
<head>
  ...
  <?php
$titulo = "Reporte General de Registro de Eventos y Niveles";
?>
...
<body>
        ...
        <div class="row heading-bg">
          ...
          <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="active"><span>Reporte Eventos y Niveles</span></li>
            </ol>
          </div>
        </div>
                          ...
                          <div class="row pa-10">
                            <div class="col-xs-12 col-md-5 pa-10">
                              <div class="form-group">
                                <form id="formCambioFecha" action="<?=base_url()?>eventos/reportes/movimientoevento"
                                  method="POST">
                                  <div class="row">
                            ...
                            <div class="col-lg-8 col-md-4 col-sm-4 col-xs-12">
                              <h5 class="txt-dark">
                                Total de Eventos Reportados por Nivel
                              </h5>
                              <br>
                            </div>
                            ...
                            <div class="col-lg-8 col-md-4 col-sm-4 col-xs-12" style="margin-top: 50px;">
                              <h5 class="txt-dark">
                                Total de Eventos Reportados por Región
                              </h5>
                              <br>
                            </div>
                            ...
                            <div class="col-lg-8 col-md-4 col-sm-4 col-xs-12" style="margin-top: 50px;">
                              <h5 class="txt-dark">
                                Total de Eventos Reportados por Región de Nivel - 01
                              </h5>
                              <br>
                            </div>
                            <div id="containerRegionUno" style="height: 400px"></div>
                            <br><br><br><br><br>
                            <div class="table-responsive">
                              <table id="tbListarRegionUno" class="table table-bordered table-sm" style="width: 100%;">
                                <thead>
                                  <tr>
                                    <th>A&ntilde;o</th>
                                    <th>Mes</th>
                            ...
                            <div class="col-lg-8 col-md-4 col-sm-4 col-xs-12" style="margin-top: 50px;">
                              <h5 class="txt-dark">
                                Total de Eventos Reportados por Región de Nivel - 02
                              </h5>
                              <br>
                            </div>
                            ...
                            <div class="col-lg-8 col-md-4 col-sm-4 col-xs-12" style="margin-top: 50px;">
                              <h5 class="txt-dark">
                                Total de Eventos Reportados por Región Nivel - 03
                              </h5>
                              <br>
                            </div>
                            <div id="containerRegionTres" style="height: 400px"></div>
                            <br><br><br><br>
                            <div class="table-responsive">
                              <table id="tbListarRegionTres" class="table table-bordered table-sm" style="width: 100%;">
                                <thead>
                                  <tr>
                                    <th>A&ntilde;o</th>
                                    <th>Mes</th>
  ...
  <script src="<?=base_url()?>public/js/eventos/reporteMovientoEvento.js?v=<?=date(" s")?>"></script>
  <script>
    var nivelGrafico = '<?=$nivelGrafico?>';
    var regionGrafico = '<?=$regionGrafico?>';
    var regionUnoGrafico = '<?=$regionUnoGrafico?>';
    var regionDosGrafico = '<?=$regionDosGrafico?>';
    var regionTresGrafico = '<?=$regionTresGrafico?>';
    var mes = '<?=$mes?>';
