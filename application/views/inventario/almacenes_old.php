                    ...
                    <div class="sm-data-box pt-20">
                      <div class="container-fluid">
                        ...
                        <div class="table-responsive main-table">
                          <table id="dt-select" class="table table-bordered table-responsive" cellspacing="0" width="100%">
                            <thead>
                              <tr>
        ...
        <form id="formRegistrar">
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-xs-6">
                <div class="form-group row">
                  <label class="modal-label col-sm-5 col-form-label py-10">Código Ubigeo</label>
                  <div class="col-sm-7">
                    <div class="form-group">
                      <div>
                        <input type="text" class="form-control" name="codigoUbigeo" id="codigoUbigeo" disabled/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xs-6">
                <div class="form-group row">
                  <label class="modal-label col-sm-5 col-form-label py-10">Nombre Ubigeo</label>
                  <div class="col-sm-7">
                    <div class="form-group">
                      <div>
                        <input type="text" class="form-control" name="nombreUbigeo" id="nombreUbigeo" disabled/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xs-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <div>
                        <input type="text" class="form-control" name="nombreTitular" id="nombreTitular" disabled/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xs-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <div>
                        <input type="text" class="form-control" name="nombreSuplente" id="nombreSuplente" disabled/>
                      </div>
                    </div>
                  </div>
                </div>
