        ...
        <div class="row heading-bg">
          ...
          <div class="col-lg-7 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
              ...
              <li><a href="<?=base_url()?>inventario"><span>Módulo de Inventarios</span></a></li>
                    ...
                    <div class="sm-data-box pt-20">
                      <div class="container-fluid">
                        ...
                        <div class="table-responsive main-table">
                          <table id="dt-select" class="table table-bordered table-hover table-responsive" cellspacing="0" width="100%">
                            <thead>
                              <tr>
