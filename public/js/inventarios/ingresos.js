$(document).ready(function () {
  ...
  var table = $('#tableArticuloInventariado').DataTable(
    {
      ...
      columns: [
        ...
        { data: "nombre_almacen" },
        {
          data: "ingreso_file",
          render: function (data, type, row, meta) {
            return data && row.estado == '1' ? `<button class="btn btn-primary btn-circle actionPdf" title="PDF" type="button" style="margin-right: 5px;">
  ...
  $("body").on("click", ".actionBlocked", function () {
    ...
    $("#decisionModal .modal-body p").html("Est\xe1 seguro de querer anular el ingreso");
  });
