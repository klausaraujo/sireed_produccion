$(document).ready(function () {
  ...
  var tableDetalle = $('.tableDetalle').DataTable(
    {
      ...
      $.ajax({
        type: 'POST',
        url: URI + 'inventario/main/obtenerStock',
        data: { idArticulo },
        dataType: 'json',
  ...
  $('body').on('click', '.product__file', function () {
    ...
    if (ruta)
      window.open(URI_MAP + 'public/inventarios/fichas/' + ruta);
  })
  ...
  var table = $('.tableArticulos').DataTable({
    ...
    buttons: [
      {
        extend: 'copy',
        title: 'Lista Logística de Inventario',
      ...
      <div class="iq-card">
        <div class="iq-card-body text-center">
            <div class="doc-profile">
              <img class="rounded-circle img-fluid avatar-80" src="${URI_MAP}public/inventarios/fotos/${element.imagen}" alt="picture">
            </div>
