function nuevo(URI) {
	...
	*/	
	...
	function calculatetab1sec1(){
		...
		$('#hospitalizacion_indicador_01').val(hospitalizacion_camas_01 /	hospitalizacion_medicos_01);	//imprimiendo en el input indicador	1
		$('#hospitalizacion_indicador_02').val(hospitalizacion_camas_02 /	hospitalizacion_enfermeras_02);	//imprimiendo en el input indicador	2
		
		$('#emergencia_indicador_01').val(emergencia_camas_01 /	emergencia_medicos_01);	//imprimiendo en el input indicador	1
		$('#emergencia_indicador_02').val(emergencia_camas_02 /	emergencia_enfermeras_02);	//imprimiendo en el input indicador	2
		
		$('#criticos_indicador_01').val(criticos_camas_01 /	criticos_medicos_01);	//imprimiendo en el input indicador	1
		$('#criticos_indicador_02').val(criticos_camas_02 /	criticos_enfermeras_02);	//imprimiendo en el input indicador	2
		
		$('#pediatricos_indicador_01').val(pediatricos_camas_01 /	pediatricos_medicos_01);	//imprimiendo en el input indicador	1
		$('#pediatricos_indicador_02').val(pediatricos_camas_02 /	pediatricos_enfermeras_02);	//imprimiendo en el input indicador	2
	...
	function calculatetab2sec1(){
		...
		const emergencia_e_externa_02_h = Number($('#emergencia_e_externa_02_h').val() || 0); //nuevo campo
		const emergencia_e_externa_02_u = Number($('#emergencia_e_externa_02_u').val() || 0); //nuevo campo
		...
		const emergencia_e_externa_03_h = Number($('#emergencia_e_externa_03_h').val() || 0); //nuevo campo
		const emergencia_e_externa_03_u = Number($('#emergencia_e_externa_03_u').val() || 0); //nuevo campo
		...
		const emergencia_pacientes_01 = Number($('#emergencia_pacientes_01').val() || 0); //nuevo campo
		const emergencia_pacientes_02 = Number($('#emergencia_pacientes_02').val() || 0); //nuevo campo
...
*/	
	...
	$("#formHospital").validate({
		rules:{
			...
			emergencia_e_externa_02_h: { required: true }, // campo nuevo
			emergencia_e_externa_02_u: { required: true }, // campo nuevo
			...
			emergencia_e_externa_03_h: { required: true }, // nuevo campo
			emergencia_e_externa_03_u: { required: true }, // nuevo campo
			emergencia_e_externa_u: { required: true },
			emergencia_espera_u: { required: true },
			emergencia_pacientes_01: { required: true }, // nuevo campo
			emergencia_pacientes_02: { required: true },  //nuevo campo
		...
		messages:{
			...
			emergencia_e_externa_02_h: { required: "Campo requerido" },  //nuevo campo
			emergencia_e_externa_02_u: { required: "Campo requerido" },  //nuevo campo
			...
			emergencia_e_externa_03_h: { required: "Campo requerido" }, //nuevo campo
			emergencia_e_externa_03_u: { required: "Campo requerido" }, //nuevo campo
			emergencia_e_externa_u: { required: "Campo requerido" },
			emergencia_espera_u: { required: "Campo requerido" },
			emergencia_pacientes_01: { required: "Campo requerido" },  //nuevo campo
			emergencia_pacientes_02: { required: "Campo requerido" }, //nuevo campo
	...
	$(document).ready(function(){	
		...
		$("input[name=emergencia_e_externa_02_h]").on("keyup", function(){calculatetab2sec1();}); //nuevo campo
		$("input[name=emergencia_e_externa_02_u]").on("keyup", function(){calculatetab2sec1();}); //nuevo campo
		...
		$("input[name=emergencia_e_externa_03_h]").on("keyup", function(){calculatetab2sec1();}); //nuevo campo
		$("input[name=emergencia_e_externa_03_u]").on("keyup", function(){calculatetab2sec1();}); //nuevo campo
		...
		$("input[name=emergencia_pacientes_01]").on("keyup", function(){calculatetab2sec1();}); //nuevo campo
		$("input[name=emergencia_pacientes_02]").on("keyup", function(){calculatetab2sec1();}); //nuevo campo
